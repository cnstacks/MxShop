# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2018-10-02 12:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.CharField(default='', max_length=100, verbose_name='区域')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('message_type', models.IntegerField(choices=[(1, '留言'), (2, '投诉'), (3, '询问'), (4, '售后'), (5, '求购')], default=1, help_text='留言类型:1(留言),2(投诉),3(询问),4(售后)，5(求购)', verbose_name='')),
